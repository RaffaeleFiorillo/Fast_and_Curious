...
def main_menu(screen: Af.Surface):
    ...
    buttons_main = [mc.Button(position_x_main, y, f"menu/buttons/1/{position_y_main.index(y) + 1}.png",
                              effects_main[position_y_main.index(y)]) for y in
                    position_y_main[:len(effects_main)]]
    m_m = mc.Menu(buttons_main, f"menu/interfaces/Main/main menu.png", screen)
...
def game_menu(screen: Af.Surface):
    ...
    buttons_game = [mc.Button(position_x_game, y, f"menu/buttons/2/{position_y_game.index(y) + 1}.png",
                              effects_game[position_y_game.index(y)]) for y in
                    position_y_game[:len(effects_game)]]
    user = mc.User()
    user.get_active_user()
    user.get_texts()
    g_m = mc.Menu(buttons_game, f"menu/interfaces/Main/game menu.png", screen, user)
...
def tutorial(screen: Af.Surface):
    ...
    user.get_active_user()
    user.get_texts()
    t = mc.Menu(buttons_tutorial, f"menu/interfaces/Main/tutorial.png", screen, user)
