# This module contains two classes. These classes are responsible for managing the game's graphics,input and output(HUD)
...
# ----------------------------------------------- SOUNDS ---------------------------------------------------------------
go_sound = audio.load_sound("game/car_ignition.WAV")                # sound of after the final count-down alert (GO)
count_down_sound = audio.load_sound("game/count_down.WAV")          # sound of the usual count down (3, 2, 1)
tic_toc_sound = audio.load_sound("game/tic_toc.WAV")                # sound of the final clock ticking
game_over_sound = audio.load_sound("game/game_over.WAV")            # sound of the match ending
start_sound = audio.load_sound("game/go.WAV")                       # sound of the GO image
wrong_letter_sound = audio.load_sound("game/letter_wrong.WAV")      # sound of the User typing a character wrong
...
class MissionAI(Mission):
    ...
    def hud_time(self):  # returns what to display on the clock of the HUD interfaec.
...
class MissionPARTS(Mission):
    ...
    def hud_time(self):  # returns what to display on the clock of the HUD interfaec. "i" makes it "infinite"
        return "i"
